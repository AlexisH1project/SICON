...
/*
		    ...
		    $hoy = "select CURDATE()";
		   	...
		   	if($motivoR == ""){
		              		echo "<script> alert('Es necesario escribir un comentario de Rechazo'); window.location.href = '../verAmarillo0.php?usuario_rol=$usuarioEdito&id_mov=$idFomope'</script>";
